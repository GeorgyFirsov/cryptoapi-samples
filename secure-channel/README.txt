...
10. Server creates a message, signs and encrypts it. After it sends ciphertext with signature to client.
11. Client decrypts received ciphertext and verifies its signature.
